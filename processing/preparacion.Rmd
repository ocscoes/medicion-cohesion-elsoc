...
C08_02: Asistir a una marcha o manifestación pacífica (w01, w02, w03 & w04)
...
data %>% select (c08_02_w01, c08_02_w02, c08_02_w03, c08_02_w04)  %>% sjlabelled::as_label(.)  %>%  dfSummary(, graph.col = FALSE)
```
...
C08_04: Usar las redes sociales para expresar su opinión en temas públicos (w01, w02, w03 & w04)
...
data %>% select (c08_04_w01, c08_04_w02, c08_04_w03, c08_04_w04)  %>% sjlabelled::as_label(.)  %>%  dfSummary(, graph.col = FALSE)
```
