...
```{r, fig.width=10, fig.height=4}
  ...
  print(levels(datlca_tot_parl$variable))
    ...
    # Relabel factors
    datlca_tot_parl$variable=factor(datlca_tot_parl$variable, labels=c("Confianza", "Diversidad", "Lazos", "Identificación", "Justicia", "Conf. Instituciones", "Territorial",  "Solidaridad", "Participación"))
