...
data$identificacion_w02 <- car::recode(data$identificacion_w02, "c(1,2)=1; 3=2; c(4,5)=3")
data$identificacion_w03 <- car::recode(data$identificacion_w03, "c(1,2)=1; 3=2; c(4,5)=3")
data$identificacion_w04 <- car::recode(data$identificacion_w04, "c(1,2)=1; 3=2; c(4,5)=3")
data$identificacion_w05 <- car::recode(data$identificacion_w05, "c(1,2)=1; 3=2; c(4,5)=3")

                                     
data$identificacion_w01<- factor(data$identificacion_w01, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))  
data$identificacion_w02<- factor(data$identificacion_w02, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))  
data$identificacion_w03<- factor(data$identificacion_w03, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))  
data$identificacion_w04<- factor(data$identificacion_w04, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))  
data$identificacion_w05<- factor(data$identificacion_w05, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))   
...
data$justicia_w01 <- car::recode(data$justicia_w01, "c(1,2)=1; 3=2; c(4,5)=3")
data$justicia_w02 <- car::recode(data$justicia_w02, "c(1,2)=1; 3=2; c(4,5)=3")
data$justicia_w03 <- car::recode(data$justicia_w03, "c(1,2)=1; 3=2; c(4,5)=3")
data$justicia_w04 <- car::recode(data$justicia_w04, "c(1,2)=1; 3=2; c(4,5)=3")
data$justicia_w05 <- car::recode(data$justicia_w05, "c(1,2)=1; 3=2; c(4,5)=3")
                                     
data$justicia_w01<- factor(data$justicia_w01, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))    
data$justicia_w02<- factor(data$justicia_w02, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))  
data$justicia_w03<- factor(data$justicia_w03, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))   
data$justicia_w04<- factor(data$justicia_w04, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))  
data$justicia_w05<- factor(data$justicia_w05, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))   
...
data$conf_institucional_w01 <- car::recode(data$conf_institucional_w01, "c(1,2)=1; 3=2; c(4,5)=3")
data$conf_institucional_w02 <- car::recode(data$conf_institucional_w02, "c(1,2)=1; 3=2; c(4,5)=3")
...
data$conf_institucional_w01<- factor(data$conf_institucional_w01, levels = c(1, 2, 3), labels = c("Nada o Poca", "Algo", "Bastante o Mucha"))     
data$conf_institucional_w02<- factor(data$conf_institucional_w02, levels = c(1, 2, 3), labels = c("Nada o Poca", "Algo", "Bastante o Mucha"))   
...
data$participacion_w01 <- car::recode(data$participacion_w01, "c(1,2)=1; 3=2; c(4,5)=3")
data$participacion_w02 <- car::recode(data$participacion_w02, "c(1,2)=1; 3=2; c(4,5)=3")
data$participacion_w03 <- car::recode(data$participacion_w03, "c(1,2)=1; 3=2; c(4,5)=3")
data$participacion_w04 <- car::recode(data$participacion_w04, "c(1,2)=1; 3=2; c(4,5)=3")

                                     
data$participacion_w01<- factor(data$participacion_w01, levels = c(1, 2, 3), labels = c("Nunca o Casi nunca", "A veces", "Frecuente o Muy frecuentemente"))  
data$participacion_w02<- factor(data$participacion_w02, levels = c(1, 2, 3), labels = c("Nunca o Casi nunca", "A veces", "Frecuente o Muy frecuentemente"))  
data$participacion_w03<- factor(data$participacion_w03, levels = c(1, 2, 3), labels = c("Nunca o Casi nunca", "A veces", "Frecuente o Muy frecuentemente"))  
data$participacion_w04<- factor(data$participacion_w04, levels = c(1, 2, 3), labels = c("Nunca o Casi nunca", "A veces", "Frecuente o Muy frecuentemente"))  
...
data$cohesion_territorial_w01 <- car::recode(data$cohesion_territorial_w01, "c(1,2)=1; 3=2; c(4,5)=3")
data$cohesion_territorial_w02 <- car::recode(data$cohesion_territorial_w02, "c(1,2)=1; 3=2; c(4,5)=3")
data$cohesion_territorial_w03 <- car::recode(data$cohesion_territorial_w03, "c(1,2)=1; 3=2; c(4,5)=3")
data$cohesion_territorial_w04 <- car::recode(data$cohesion_territorial_w04, "c(1,2)=1; 3=2; c(4,5)=3")
                                     
data$cohesion_territorial_w01<- factor(data$cohesion_territorial_w01, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))    
data$cohesion_territorial_w02<- factor(data$cohesion_territorial_w02, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))    
data$cohesion_territorial_w03<- factor(data$cohesion_territorial_w03, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))    
data$cohesion_territorial_w04<- factor(data$cohesion_territorial_w04, levels = c(1, 2, 3), labels = c("En desacuerdo", "Ni de acuerdo ni en desacuerdo", "De acuerdo"))    
...
ggsave(alluvial_conf.interpersonal, file = "bookdown-files/output/graphs/alluvial_conf.interpersonal.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_diversidad, file = "bookdown-files/output/graphs/alluvial_diversidad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_identificacion, file = "bookdown-files/output/graphs/alluvial_identificacion.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_justicia, file = "bookdown-files/output/graphs/alluvial_justicia.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_conf.institucional, file = "bookdown-files/output/graphs/alluvial_conf.institucional.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_solidaridad, file = "bookdown-files/output/graphs/alluvial_solidaridad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_participacion, file = "bookdown-files/output/graphs/alluvial_participacion.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_cohesion_territorial, file = "bookdown-files/output/graphs/alluvial_cohesion_territorial.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
