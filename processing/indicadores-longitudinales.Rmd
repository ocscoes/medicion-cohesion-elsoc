...
ggsave(alluvial_lazos, file = "bookdown-files/output/figuras-svg-cepal/Grafico 27 Cambios en la subdimension Lazos.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_conf.interpersonal, file = "bookdown-files/output/figuras-svg-cepal/Grafico 28 Cambios en la subdimension confianza interpersonal.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_diversidad, file = "bookdown-files/output/figuras-svg-cepal/Grafico 29 Cambios en la subdimension reconocimiento y respeto de la diversidad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_identificacion, file = "bookdown-files/output/figuras-svg-cepal/Grafico 30 Cambios en la subdimension identificacion con el pais.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_justicia, file = "bookdown-files/output/figuras-svg-cepal/Grafico 31 Cambios en la subdimension percepcion de justicia.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_conf.institucional, file = "bookdown-files/output/figuras-svg-cepal/Grafico 32 Cambios en la subdimension confianza institucional.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_solidaridad, file = "bookdown-files/output/figuras-svg-cepal/Grafico 33 Cambios en la subdimension solidaridad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_participacion, file = "bookdown-files/output/figuras-svg-cepal/Grafico 34 Cambios en la subdimension participacion civica.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_cohesion_territorial, file = "bookdown-files/output/figuras-svg-cepal/Grafico 35 Cambios en la subdimension vinculos territoriales.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
