...
ggsave(alluvial_conf.interpersonal, file = "bookdown-files/output/graphs/alluvial_conf_interpersonal.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_conf.institucional, file = "bookdown-files/output/graphs/alluvial_conf_institucional.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
