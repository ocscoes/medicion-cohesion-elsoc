...
data %>% select(lazos_w01, lazos_w03, lazos_w05)  %>%  dfSummary(, graph.col = FALSE)
```
...
data %>% select(conf_interpersonal_w01, conf_interpersonal_w02, conf_interpersonal_w03, conf_interpersonal_w04, conf_interpersonal_w05)  %>%  dfSummary(, graph.col = FALSE)
```
...
data %>% select(diversidad_w01, diversidad_w03)  %>%  summarytools::dfSummary(, graph.col = FALSE)
```
...
data %>% select(identificacion_w01, identificacion_w02, identificacion_w03, identificacion_w04, identificacion_w05)  %>%  dfSummary(, graph.col = FALSE)
```
...
data %>% select(justicia_w01, justicia_w02, justicia_w03, justicia_w04, justicia_w05)  %>%  dfSummary(, graph.col = FALSE)
```
...
data %>% select(conf_institucional_w01, conf_institucional_w02, conf_institucional_w03, conf_institucional_w04, conf_institucional_w05)  %>%  dfSummary(, graph.col = FALSE)
```
...
data %>% select(solidaridad_w01, solidaridad_w02, solidaridad_w03, solidaridad_w04, solidaridad_w05)  %>%  dfSummary(, graph.col = FALSE)
```
...
data %>% select(participacion_w01, participacion_w02, participacion_w03, participacion_w04, participacion_w05) %>%  dfSummary(, graph.col = FALSE)
```
...
data %>% select(cohesion_territorial_w01, cohesion_territorial_w02, cohesion_territorial_w03, cohesion_territorial_w04) %>% dfSummary(, graph.col = FALSE)
```
...
data %>% select(participacion_w01, participacion_w02, participacion_w03, participacion_w04)  %>% sjlabelled::as_label(.)  %>%  dfSummary(, graph.col = FALSE)
```
...
ggsave(alluvial_lazos, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.3 Cambios en la subdimension Lazos.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
alluvial_conf.interpersonal <- ggplot(datos.conf.interpersonal, 
    ...
    theme(legend.position = 'top',
          ...
          plot.caption = element_text(hjust = 0)) +
    scale_fill_viridis_d(begin = 0, end = .95, direction = -1, option = 'viridis') +
    geom_shadowtext(data = etiquetas.conf.interpersonal, 
              aes(label = ifelse(porcentaje > 0.03 , scales::percent(porcentaje, accuracy = .1),"")),
              position = position_stack(vjust = .5),
              show.legend = FALSE,
              size = 4,
...
ggsave(alluvial_conf.interpersonal, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.1 Cambios en la subdimension confianza interpersonal.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
alluvial_diversidad <- ggplot(datos.diversidad, aes(x = ola, fill = diversidad, stratum = diversidad,
    ...
    theme(text=element_text(family="Arial", size=12),
          ...
          plot.caption = element_text(hjust = 0)) +
    scale_fill_viridis_d(begin = 0, end = .95, direction = -1, option = 'viridis') +
    geom_shadowtext(data = etiquetas.diversidad, 
              aes(label = ifelse(porcentaje > 0.03 , scales::percent(porcentaje, accuracy = .1),"")),
              position = position_stack(vjust = .5),
              show.legend = FALSE,
              size = 4,
...
Nota: Los indicadores de Grado de confianza en personas mapuche, inmigrantes y homosexuales
solo estan disponibles para los años 2016 y 2018")
...
ggsave(alluvial_diversidad, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.2 Cambios en la subdimension reconocimiento y respeto de la diversidad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
alluvial_identificacion <- ggplot(datos.identificacion, aes(x = ola, fill = identificacion, stratum = identificacion,
    ...
    theme(legend.position = 'top',
          ...
          plot.caption = element_text(hjust = 0)) +
    scale_fill_viridis_d(begin = 0, end = .95, direction = -1, option = 'viridis') +
    geom_shadowtext(data = etiquetas.identificacion, 
              aes(label = ifelse(porcentaje > 0.03 , scales::percent(porcentaje, accuracy = .1),"")),
              position = position_stack(vjust = .5),
              show.legend = FALSE,
              size = 4,
...
ggsave(alluvial_identificacion, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.4 Cambios en la subdimension identificacion con el pais.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
alluvial_justicia <- ggplot(datos.justicia, aes(x = ola, fill = justicia, stratum = justicia,
    ...
    theme(legend.position = 'top',
          ...
          plot.caption = element_text(hjust = 0)) +
    scale_fill_viridis_d(begin = 0, end = .95, direction = -1, option = 'viridis') +
    geom_shadowtext(data = etiquetas.justicia, 
              aes(label = ifelse(porcentaje > 0.03 , scales::percent(porcentaje, accuracy = .1),"")),
              position = position_stack(vjust = .5),
              show.legend = FALSE,
              size = 4,
...
ggsave(alluvial_justicia, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.5 Cambios en la subdimension percepcion de justicia.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(alluvial_conf.institucional, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.6 Cambios en la subdimension confianza institucional.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
alluvial_solidaridad <- ggplot(datos.solidaridad, aes(x = ola, fill = solidaridad, stratum = solidaridad,
    ...
    theme(legend.position = 'top',
          ...
          plot.caption = element_text(hjust = 0)) +
    scale_fill_viridis_d(begin = 0, end = .95, direction = -1, option = 'viridis') +
    geom_shadowtext(data = etiquetas.solidaridad, 
              aes(label = ifelse(porcentaje > 0.03 , scales::percent(porcentaje, accuracy = .1),"")),
              position = position_stack(vjust = .5),
              show.legend = FALSE,
              size = 4,
...
ggsave(alluvial_solidaridad, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.7 Cambios en la subdimension solidaridad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
alluvial_participacion <- ggplot(datos.participacion, aes(x = ola, fill = participacion, stratum = participacion,
    ...
    theme(legend.position = 'top',
          ...
          plot.caption = element_text(hjust = 0)) +
    scale_fill_viridis_d(begin = 0, end = .95, direction = -1, option = 'viridis') +
    geom_shadowtext(data = etiquetas.participacion, 
              aes(label = ifelse(porcentaje > 0.03 , scales::percent(porcentaje, accuracy = .1),"")),
              position = position_stack(vjust = .5),
              show.legend = FALSE,
              size = 4,
...
Nota: Los item Firma una carta o peticion apoyando una causa y Participa en huelgas no se 
encuentran disponibles para el año 2020, por lo que no se estimo este indicador en dicho año")
...
ggsave(alluvial_participacion, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.8 Cambios en la subdimension participacion civica.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
alluvial_cohesion_territorial <- ggplot(datos.cohesion_territorial, aes(x = ola, fill = cohesion_territorial, stratum = cohesion_territorial,
    ...
    theme(legend.position = 'top',
          ...
          plot.caption = element_text(hjust = 0)) +
    scale_fill_viridis_d(begin = 0, end = .95, direction = -1, option = 'viridis') +
    geom_shadowtext(data = etiquetas.cohesion_territorial, 
              aes(label = ifelse(porcentaje > 0.03 , scales::percent(porcentaje, accuracy = .1),"")),
              position = position_stack(vjust = .5),
              show.legend = FALSE,
              size = 4,
...
Nota: Los item Este barrio es ideal para mi, Me siento integrado/a en este barrio, Me identifico con la
gente de este barrio y Este barrio es parte de mi solo están disponibles para los años 2016-2019")
...
ggsave(alluvial_cohesion_territorial, file = "bookdown-files/output/figuras-svg-cepal/Figura 2.9 Cambios en la subdimension vinculos territoriales.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
