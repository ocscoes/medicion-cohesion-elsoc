...
data_vertical_w05 <- data_vertical_w05 %>% filter(instituciones>0 | participacion>0)
...
## Horizontal x educacion 2 categorias
...
ggsave(plot_horizontal_educ, file="output/graphs/plot_horizontal_educ_rec.png")
```
...
ggsave(plot_vertical_educ, file="output/graphs/plot_vertical_educ_rec.png")
```
