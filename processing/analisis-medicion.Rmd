...
ggsave(lazos, file = "bookdown-files/output/figuras-svg-cepal/Grafico 6 Item subdimension Lazos.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 7 Asociacion de indicadores de subdimension lazos.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
ggsave(conf_interpersonal, file = "bookdown-files/output/figuras-svg-cepal/Grafico 1 Confianza interpersonal.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 2 Asociacion de indicadores de Confianza interpersonal.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(conf_interpersonal_cor,
  method = "color",
  addCoef.col = "#000390",
...
ggsave(prejuicios, file = "bookdown-files/output/figuras-svg-cepal/Grafico 3 Prejuicios hacia inmigrantes y adopcion homoparental.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(diversidad, file = "bookdown-files/output/figuras-svg-cepal/Grafico 4 Grado de confianza hacia distintos grupos sociales.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 5 Asociacion de indicadores de la subdimension Reconocimiento y respeto de la diversidad.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(diversidad_cor,
  method = "color",
  addCoef.col = "#000390",
...
write_xlsx(div_fa, path = "bookdown-files/output/tables-excel-cepal/cuadro 2.xlsx")
```
...
ggsave(identificacion, file = "bookdown-files/output/figuras-svg-cepal/Grafico 8 Identificacion y orgullo con Chile.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(justicia, file = "bookdown-files/output/figuras-svg-cepal/Grafico 9 Percepcion de recompensa por esfuerzo e inteligencia.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
ggsave(confianza_institucional, file = "bookdown-files/output/figuras-svg-cepal/Grafico 10 Confianza en instituciones.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 11 Asociacion de indicadores de confianza institucional.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(conf_institucional_cor,
  method = "color",
  addCoef.col = "#000390",
...
write_xlsx(inst_fa, path = "bookdown-files/output/tables-excel-cepal/cuadro 3.xlsx")
```
...
ggsave(solidaridad, file = "bookdown-files/output/figuras-svg-cepal/Grafico 12 Acciones de solidaridad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 13 Asociacion de indicadores de solidaridad.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(solidaridad_cor,
  method = "color",
  addCoef.col = "#000390",
...
write_xlsx(solidaridad_fa, path = "bookdown-files/output/tables-excel-cepal/cuadro 4.xlsx")
```
...
ggsave(part_civica, file = "bookdown-files/output/figuras-svg-cepal/Grafico 14 Participacion en actividades civicas.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 15 Asociacion de indicadores de participacion civica.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(part_civica_cor,
  method = "color",
  addCoef.col = "#000390",
...
ggsave(part_organizaciones, file = "bookdown-files/output/figuras-svg-cepal/Grafico 16 Participacion en organizaciones sociales.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 17 Asociacion de indicadores participacion en organizaciones sociales.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(part_organizaciones_cor,
  method = "color",
  addCoef.col = "#000390",
...
ggsave(part_electoral, file = "bookdown-files/output/figuras-svg-cepal/Grafico 18 Participacion en elecciones 2013.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
write_xlsx(participacion_fa, path = "bookdown-files/output/tables-excel-cepal/cuadro 5.xlsx")
```
...
ggsave(conf_vecinos, file = "bookdown-files/output/figuras-svg-cepal/Grafico 19 Confianza en vecinos.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
ggsave(cohesion_barrial, file = "bookdown-files/output/figuras-svg-cepal/Grafico 20 Cohesion en el barrio.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 21 Asociacion de indicadores de cohesion barrial.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(cohesion_barrial_cor,
  method = "color",
  addCoef.col = "#000390",
...
ggsave(sociabilidad_barrial, file = "bookdown-files/output/figuras-svg-cepal/Grafico 22 Sociabilidad barrial.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 23 Asociacion de indicadores de sociabilidad barrial.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(sociabilidad_barrial_cor,
  method = "color",
  addCoef.col = "#000390",
...
ggsave(sat_residencial, file = "bookdown-files/output/figuras-svg-cepal/Grafico 24 Satisfaccion con el barrio.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 25 Asociacion de indicadores de satisfaccion residencial.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(sat_residencial_cor,
  method = "color",
  addCoef.col = "#000390",
...
write_xlsx(cohesion_territorial_fa, path = "bookdown-files/output/tables-excel-cepal/cuadro 6.xlsx")
```
...
write_xlsx(collapse_rows_cohesion, path = "bookdown-files/output/tables-excel-cepal/cuadro 1.xlsx")
```
...
svglite("bookdown-files/output/figuras-svg-cepal/Grafico 26 Asociacion de las subdimensiones de cohesion social.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
corrplot::corrplot(cohesion_social_cor,
  method = "color",
  addCoef.col = "#000390",
