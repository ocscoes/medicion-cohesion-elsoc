...
graf1<-  plot_stackfrq(tabla1, geom.size = 0.14) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
graf1
ggsave(graf1, file = "../bookdown-files/output/graphs/lazos.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
graf2 <- plot_stackfrq(tabla2, geom.colors = "RdBu", geom.size = 0.33) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
ggsave(graf2, file = "../bookdown-files/output/graphs/confianza-interpersonal.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
diag(conf_interpersonal) = NA
rownames(conf_interpersonal) <- c("A. Se puede confiar en la mayoria de las personas",
                                  "B. La mayoria de las personas trata de ayudar a los demas",
                                  "C. La mayoria de las personas trata de ser justa")
colnames(conf_interpersonal) <-c("(A)", "(B)","(C)")

png("../bookdown-files/output/graphs/confianza-interpersonal_cor.png",width=600,height=600)
corrplot::corrplot(conf_interpersonal,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
labelled::remove_labels(tabla3)
frq(tabla3$r12_03_w01)

str(tabla3$r12_03_w01)
col_names <- names(tabla3)
col_names
tabla3[,col_names] <- lapply(tabla3[,col_names] , factor)
tabla3 <- as.factor(tabla3)
summary(tabla3)
tabla3 = droplevels(tabla3)

to_label(tabla3, drop.levels=TRUE)
...
graf3<- plot_stackfrq(tabla3, geom.colors = "RdBu", geom.size = 0.33) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf3
ggsave(graf3, file = "../bookdown-files/output/graphs/prejuicios.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
graf4<- plot_stackfrq(tabla4, geom.size = 0.33) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf4
ggsave(graf4, file = "../bookdown-files/output/graphs/diversidad.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
diversidad<-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(diversidad) = NA
rownames(diversidad) <- c("A. Chile pierde su identidad con la llegada de inmigrantes",
...
colnames(diversidad) <-c("(A)", "(B)","(C)", "(D)", "(E)", "(F)")

png("../bookdown-files/output/graphs/diversidad_cor.png",width=600,height=600)
corrplot::corrplot(diversidad,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
graf5<-plot_stackfrq(tabla5, geom.colors = "RdBu", geom.size = 0.25) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf5
ggsave(graf5, file = "../bookdown-files/output/graphs/identificacion.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
graf6<-plot_stackfrq(tabla6, geom.colors = "RdBu", geom.size = 0.25) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf6
ggsave(graf6, file = "../bookdown-files/output/graphs/justicia.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
graf7 <- plot_stackfrq(tabla7, geom.size = 0.9) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf7
ggsave(graf7, file = "../bookdown-files/output/graphs/confianza-institucional.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
conf_institucional<-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(conf_institucional) = NA
rownames(conf_institucional) <- c("A. Confianza en el gobierno",
...
colnames(conf_institucional) <-c("(A)", "(B)","(C)", "(D)", "(E)", "(F)", "(G)", "(H)")




png("../bookdown-files/output/graphs/confianza-institucional_cor.png",width=600,height=600)
corrplot::corrplot(conf_institucional,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
graf8 <- plot_stackfrq(tabla8, geom.size = 0.9) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf8
ggsave(graf8, file = "../bookdown-files/output/graphs/solidaridad.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
solidaridad<-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(solidaridad) = NA
rownames(solidaridad) <- c("A. Visita la casa de algún vecino",
...
colnames(solidaridad) <-c("(A)", "(B)","(C)", "(D)", "(E)", "(F)", "(G)", "(H)")

png("../bookdown-files/output/graphs/solidaridad_cor.png",width=600,height=600)
corrplot::corrplot(solidaridad,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
graf9 <- plot_stackfrq(tabla9, geom.size = 0.45) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf9
ggsave(graf9, file = "../bookdown-files/output/graphs/participacion-civica.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
part_civica<-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(part_civica) = NA
rownames(part_civica) <- c("A. Firma una carta o petición",
                          "B. Asiste a una marcha o manifestación",
                          "C. Participa en una huelga",
                          "D. Usa redes sociales para expresar su opinión")
colnames(part_civica) <-c("(A)", "(B)","(C)", "(D)")

png("../bookdown-files/output/graphs/participacion-civica_cor.png",width=600,height=600)
corrplot::corrplot(part_civica,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
graf10 <- plot_stackfrq(tabla10, geom.size = 0.9) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf10
ggsave(graf10, file = "../bookdown-files/output/graphs/participacion-organizaciones.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
part_organizaciones <-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(part_organizaciones) = NA
rownames(part_organizaciones) <- c("A. Junta de vecinos u otra organización",
...
colnames(part_organizaciones) <-c("(A)", "(B)","(C)", "(D)", "(E)", "(F)", "(G)", "(H)")

png("../bookdown-files/output/graphs/participacion-organizaciones_cor.png",width=600,height=600)
corrplot::corrplot(part_organizaciones,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
graf11 <- plot_stackfrq(tabla11, geom.size = 0.25) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf11
ggsave(graf11, file = "../bookdown-files/output/graphs/participacion-electoral.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
png("../bookdown-files/output/graphs/participacion-electoral_cor.png",width=600,height=600)
...
graf12 <- plot_stackfrq(tabla12, geom.size = 0.14) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf12
ggsave(graf12, file = "../bookdown-files/output/graphs/confianza-vecinos.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
graf13<-plot_stackfrq(tabla13, geom.colors = "RdBu", geom.size = 0.45) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf13
ggsave(graf13, file = "../bookdown-files/output/graphs/cohesion-barrial.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
cohesion_barrial <-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(cohesion_barrial) = NA
rownames(cohesion_barrial) <- c("A. Este barrio es ideal para mi",
                          "B. Me siento integrado/a en este barrio",
                          "C. Me identifico con la gente de este barrio",
                          "D. Este barrio es parte de mi")
colnames(cohesion_barrial) <-c("(A)", "(B)","(C)", "(D)")

png("../bookdown-files/output/graphs/cohesion-barrial_cor.png",width=600,height=600)
corrplot::corrplot(cohesion_barrial,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
graf14<-plot_stackfrq(tabla14, geom.colors = "RdBu", geom.size = 0.45) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf14
ggsave(graf14, file = "../bookdown-files/output/graphs/sociabilidad-barrial.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
sociabilidad_barrial <-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(sociabilidad_barrial) = NA
rownames(sociabilidad_barrial) <- c("A. En este barrio es fácil hacer amigos",
                          "B. La gente en este barrio es sociable",
                          "C. La gente en este barrio es cordial",
                          "D. La gente en este barrio es colaboradora")
colnames(sociabilidad_barrial) <-c("(A)", "(B)","(C)", "(D)")

png("../bookdown-files/output/graphs/sociabilidad-barrial_cor.png",width=600,height=600)
corrplot::corrplot(sociabilidad_barrial,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
...
graf15<-plot_stackfrq(tabla15, geom.colors = "RdBu", geom.size = 0.9) +
  theme(axis.text.y = element_text(colour = "black", size = 10),
        axis.text.x = element_text(colour = "black", size = 10),
        legend.text = element_text(size = 10),
        legend.position="bottom")
...
graf15
ggsave(graf15, file = "../bookdown-files/output/graphs/satisfaccion-residencial.png",device = "png",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
sat_residencial <-
  ...
  lavaan::lavCor(., ordered=names(.))
diag(sat_residencial) = NA
rownames(sat_residencial) <- c("A. Seguridad del barrio",
                          "B. Conectividad",
...
colnames(sat_residencial) <-c("(A)", "(B)","(C)", "(D)", "(E)", "(F)", "(G)", "(H)")

png("../bookdown-files/output/graphs/satisfaccion-residencial_cor.png",width=600,height=600)
corrplot::corrplot(sat_residencial,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
  tl.col = "black",
