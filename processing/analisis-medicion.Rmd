...
svglite("bookdown-files/output/graphs/lazos_cor.svg", width = 7, height = 7, pointsize = 10)
...
ggsave(conf_interpersonal, file = "bookdown-files/output/graphs/confianza-interpersonal.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/confianza-interpersonal_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
prejuicios
ggsave(prejuicios, file = "bookdown-files/output/graphs/prejuicios.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
diversidad
ggsave(diversidad, file = "bookdown-files/output/graphs/diversidad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/diversidad_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
svglite("bookdown-files/output/graphs/relaciones_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
identificacion
ggsave(identificacion, file = "bookdown-files/output/graphs/identificacion.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
justicia
ggsave(justicia, file = "bookdown-files/output/graphs/justicia.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
ggsave(confianza_institucional, file = "bookdown-files/output/graphs/confianza-institucional.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/confianza-institucional_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
svglite("bookdown-files/output/graphs/pertenencia_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
solidaridad
ggsave(solidaridad, file = "bookdown-files/output/graphs/solidaridad.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/solidaridad_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
part_civica
ggsave(part_civica, file = "bookdown-files/output/graphs/participacion-civica.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/participacion-civica_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
part_organizaciones
ggsave(part_organizaciones, file = "bookdown-files/output/graphs/participacion-organizaciones.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/participacion-organizaciones_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
part_electoral
ggsave(part_electoral, file = "bookdown-files/output/graphs/participacion-electoral.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/bien_comun_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
conf_vecinos
ggsave(conf_vecinos, file = "bookdown-files/output/graphs/confianza-vecinos.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
cohesion_barrial
ggsave(cohesion_barrial, file = "bookdown-files/output/graphs/cohesion-barrial.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/cohesion-barrial_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
ggsave(sociabilidad_barrial, file = "bookdown-files/output/graphs/sociabilidad-barrial.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/sociabilidad-barrial_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
sat_residencial
ggsave(sat_residencial, file = "bookdown-files/output/graphs/satisfaccion-residencial.svg",device = "svg",width = 25,height = 13,dpi = "retina",units = "cm")
```
...
svglite("bookdown-files/output/graphs/satisfaccion-residencial_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
...
svglite("bookdown-files/output/graphs/cohesion_social_cor.svg", width = 7, height = 7, pointsize = 10)
par(family="Arial", size= 10)
