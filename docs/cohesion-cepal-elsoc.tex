...
En este capítulo se seleccionarán indicadores de la encuesta \href{https://coes.cl/encuesta-panel/}{ELSOC} (Estudio Longitudinal Social de Chile) que se asocien al contenido de cada una de las subdimensiones del concepto de cohesión social. Por ejemplo, si consideramos la dimensión ``Relaciones Sociales de Igualdad'', comenzaremos con la subdimensión ``lazos'' identificando indicadores de la encuesta que representen este concepto, y con la información disponible elaboraremos una propuesta para cubrir cada una de las subdimensiones.
...
\toprule
\endhead
\includegraphics[width=5.20833in,height=\textheight]{output/tables/inst_fa.png}\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
\includegraphics[width=5.20833in,height=\textheight]{output/tables/solidaridad_fa.png}\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
\includegraphics[width=5.20833in,height=\textheight]{output/tables/part_civica_fa.png}\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
\includegraphics[width=5.20833in,height=\textheight]{output/tables/organizaciones_fa.png}\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
\includegraphics[width=5.20833in,height=\textheight]{output/tables/cohesion_barrial_fa.png}\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
\includegraphics[width=5.20833in,height=\textheight]{output/tables/sociabilidad_barrial_fa.png}\tabularnewline
\bottomrule
\end{longtable}
...
\toprule
\endhead
\includegraphics[width=5.20833in,height=\textheight]{output/tables/sat_residencial_fa.png}\tabularnewline
\bottomrule
\end{longtable}
