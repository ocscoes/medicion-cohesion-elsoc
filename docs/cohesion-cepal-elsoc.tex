...
\caption{\label{tab:clases-region}Distribución de las clases latentes de cohesin social por región}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:clases-escolaridad}Efecto del promedio de escolaridad del barrio sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Promedio de años de escolaridad sostenedor del hogar (sd)} \\
\cline{2-3}
Clases de cohesión social & Menor escolaridad & Alta escolaridad\\
\hline
...
\caption{\label{tab:clases-ocupados}Efecto de la cantidad de trabajadores ocupados sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Cantidad de trabajadores ocupados} \\
\cline{2-3}
Clases de cohesión social & Menor cantidad de ocupados & Alta cantidad de ocupados\\
\hline
...
\caption{\label{tab:clases-cesantes}Efecto de la cantidad de trabajadores cesantes sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Cantidad de trabajadores buscando empleo} \\
\cline{2-3}
Clases de cohesión social & Menor cantidad de cesantes & Alta cantidad de cesantes\\
\hline
...
\caption{\label{tab:clases-acced}Efecto del acceso a colegios sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Acceso a colegios} \\
\cline{2-3}
Clases de cohesión social & Menor acceso a colegios & Alto acceso a colegios\\
\hline
