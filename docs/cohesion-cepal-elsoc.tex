...
\caption{\label{tab:descriptivos-cohesion}Descriptivos medición de cohesión social.}
\centering
\resizebox{\linewidth}{!}{
...
\caption{\label{tab:clases-cesantes}Efecto de la cantidad de trabajadores cesantes sobre las clases de cohesion social}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r}
\hline
...
\caption{\label{tab:clases-acced}Efecto del acceso a colegios sobre las clases de cohesion social}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r}
\hline
