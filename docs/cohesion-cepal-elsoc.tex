...
\caption{\label{tab:descriptivos-cohesion}Descriptivos de medición de cohesión social.}
\centering
\resizebox{\linewidth}{!}{
...
\hline
\textbf{Lazos} & Cantidad de personas que se conocen con diferentes ocupaciones. & 1 - 5 & 3.542 (1.032)\\
\cline{1-4}
 & Se puede confiar en la mayoria de las personas. &  & \\
\cline{2-2}
\multirow{-2}{*}{\raggedright\arraybackslash \textbf{Confianza interpersonal}} & La mayoria de las personas tratan de ayudar a las demas. & \multirow{-2}{*}{\raggedright\arraybackslash 1 - 3} & \multirow{-2}{*}{\raggedright\arraybackslash 1.311 (0.522)}\\
\cline{1-4}
 & Grado de confianza con personas homosexuales. &  & \\
\cline{2-2}
 & Grado de confianza con personas mapuche. &  & \\
\cline{2-2}
\multirow{-3}{*}{\raggedright\arraybackslash \textbf{Reconocimiento y respeto de la diversidad}} & Grado de confianza con personas inmigrantes. &  & \multirow{-3}{*}{\raggedright\arraybackslash 2.78 (1.053)}\\
\cline{1-2}
\cline{4-4}
 & Me siento orgulloso de ser chileno. &  & \\
\cline{2-2}
\multirow{-2}{*}{\raggedright\arraybackslash \textbf{Identificación con el país}} & Me identifico con Chile. &  & \multirow{-2}{*}{\raggedright\arraybackslash 4.246 (0.669)}\\
\cline{1-2}
\cline{4-4}
 & En Chile las personas son recompensadas por sus esfuerzos. &  & \\
\cline{2-2}
\multirow{-2}{*}{\raggedright\arraybackslash \textbf{Percepción de justicia}} & En Chile las personas son recompensadas por su inteligencia. &  & \multirow{-2}{*}{\raggedright\arraybackslash 2.661 (0.978)}\\
\cline{1-2}
\cline{4-4}
...
\caption{Tipología de las clases latentes de cohesión social.}\label{fig:clases-latentes}
\end{figure}
...
\hypertarget{perfil-movilizado-dimensiuxf3n-horizontal-42}{%
\subsubsection{Perfil Movilizado: Dimensión horizontal (42\%)}\label{perfil-movilizado-dimensiuxf3n-horizontal-42}}
...
\hypertarget{perfil-institucional.-dimensiuxf3n-vertical-32}{%
\subsubsection{Perfil Institucional. Dimensión vertical (32\%)}\label{perfil-institucional.-dimensiuxf3n-vertical-32}}
...
\hypertarget{perfil-atomizado-26}{%
\subsubsection{Perfil Atomizado (26\%)}\label{perfil-atomizado-26}}
...
\caption{\label{tab:clases-region}Distribución de las clases latentes de cohesión social por región}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{4}{c}{Region} \\
\cline{2-5}
Clases de cohesión social & Movilizados & Institucionales & Atomizados & N=100\%\\
\hline
...
\caption{Mapa de la distribución de las clases latentes de cohesión social por región.}\label{fig:mapas-region}
\end{figure}
...
\caption{\label{tab:tabla-empleo}Efecto del tipo de empleo sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Tipo de empleo} \\
\cline{2-3}
Clases de cohesión social & Formal & Informal\\
\hline
Movilizados & 55.7 & 43.6\\
\hline
Institucionales & 23.5 & 34.1\\
\hline
...
\hypertarget{clave-para-la-lectura-de-las-tablas}{%
\subsubsection{Clave para la lectura de las tablas}\label{clave-para-la-lectura-de-las-tablas}}
...
\caption{\label{tab:clases-edad}Efecto de la edad sobre las clases de cohesión social en porcentaje}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r|r|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{5}{c}{Grupos de edad} \\
\cline{2-6}
Clases de cohesión social & Entre 18 y 29 & Entre 30 y 39 & Entre 40 y 49 & Entre 50 y 59 & Mas de 60\\
\hline
Movilizados & 66.3 & 57.0 & 49.6 & 39.7 & 21.8\\
\hline
Institucionales & 9.1 & 14.3 & 27.7 & 35.2 & 57.2\\
\hline
...
\caption{\label{tab:clases-sexo}Efecto del sexo sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Sexo} \\
\cline{2-3}
Clases de cohesión social & Hombre & Mujer\\
\hline
Movilizados & 47.7 & 40.8\\
\hline
Institucionales & 31.7 & 33.0\\
\hline
...
\caption{\label{tab:clases-educacion}Efecto de la educación sobre las clases de cohesión social en porcentaje}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{4}{c}{Nivel educacional} \\
\cline{2-5}
Clases de cohesión social & Menos que media completa & Media completa & Educacion tecnica superior & Educacion universitaria o Postgrado\\
\hline
Movilizados & 21.2 & 44.4 & 57.1 & 72.7\\
\hline
Institucionales & 50.0 & 27.9 & 21.4 & 15.9\\
\hline
...
\caption{\label{tab:clases-ingresos}Efecto de los quintiles de ingreso sobre las clases de cohesión social en porcentaje}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r|r|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{5}{c}{Quintiles de ingresos} \\
\cline{2-6}
Clases de cohesión social & Quintil 1 & Quintil 2 & Quintil 3 & Quintil 4 & Quintil 5\\
\hline
Movilizados & 20.6 & 38.1 & 39.1 & 48.4 & 69.5\\
\hline
Institucionales & 49.7 & 33.6 & 33.5 & 27.7 & 18.6\\
\hline
...
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Dispersión de la media de años de escolaridad sostenedor del hogar} \\
\cline{2-3}
Clases de cohesión social & Menor dispersión & Mayor dispersión\\
\hline
Movilizados & 44.3 & 39.9\\
\hline
Institucionales & 28.6 & 44.2\\
\hline
...
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Cantidad de trabajadores ocupados} \\
\cline{2-3}
Clases de cohesión social & Menor proporción de ocupados & Mayor proporción de ocupados\\
\hline
Movilizados & 41.9 & 47.2\\
\hline
Institucionales & 35.5 & 23.7\\
\hline
...
\caption{\label{tab:clases-cesantes}Efecto de la proporción de trabajadores cesantes sobre las clases de cohesion social}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Cantidad de trabajadores buscando empleo} \\
\cline{2-3}
Clases de cohesión social & Menor proporción de desempleados & Mayor proporción de desempleados\\
\hline
Movilizados & 43.7 & 41.8\\
\hline
Institucionales & 34.2 & 27.5\\
\hline
...
\caption{\label{tab:clases-acced}Efecto de la proximidad a establecimientos educacionales sobre las clases de cohesion social}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|r|r}
\hline
...
\cline{2-3}
Clases de cohesión social & Menor proximidad & Alta proximidad\\
\hline
Movilizados & 45.1 & 37.6\\
\hline
Institucionales & 29.8 & 40.9\\
\hline
...
\caption{\label{tab:clases-accser}Efecto del acceso a servicios y equipamientos públicos sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Acceso a servicios publicos} \\
\cline{2-3}
Clases de cohesión social & Menor acceso a servicios & Alto acceso a servicios\\
\hline
Movilizados & 43.2 & 53.3\\
\hline
Institucionales & 28.8 & 28.9\\
\hline
...
\caption{\label{tab:clases-etnia}Efecto de la pertenencia a una etnia sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Etnia} \\
\cline{2-3}
Clases de cohesión social & Ninguna & Pertenece a una etnia\\
\hline
Movilizados & 42.3 & 50.0\\
\hline
Institucionales & 33.5 & 26.7\\
\hline
...
\caption{\label{tab:clases-nacion}Efecto de ser migrante sobre las clases de cohesión social en porcentaje}
\centering
\begin{tabular}[t]{l|r|r}
\hline
\multicolumn{1}{c|}{ } & \multicolumn{2}{c}{Nacionalidad} \\
\cline{2-3}
Clases de cohesión social & Nacionalidad chilena & Otra nacionalidad\\
\hline
Movilizados & 43.4 & 33.3\\
\hline
Institucionales & 32.6 & 29.6\\
\hline
Atomizados & 24.0 & 37.0\\
\hline
N=100\% & 1463.0 & 27.0\\
\hline
\end{tabular}
