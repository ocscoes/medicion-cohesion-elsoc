...
## Mapeo en Chile de niveles de cohesión por regiones (mapas de calor)
...
tablae1tot <- tabla1 %>% filter(Var1=="Sum" & Var2=="Movilizados") %>% select(Freq)
tablae1 <- rbind(tablae1, tablae1tot)

tablae2 <- tabla2 %>% filter(Var2=="Institucionales") %>% select(Freq)
tablae2tot <- tabla1 %>% filter(Var1=="Sum" & Var2=="Institucionales") %>% select(Freq)
...
## Tablas con niveles de cohesión por elementos habilitadores
