...
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Agrupacion territorial",
                            "Region",
                            "Movilizados",
                            "Legitimantes",
                            "Atomizados",
                            "N=100%"),
             caption = "Distribución de los perfiles de cohesión social por región") %>%
  kable_styling(bootstrap_options = c("striped", "hover"),latex_options = c("scale_down")) %>%
  kableExtra::add_header_above(header = c(" "=2, "Perfiles de cohesión social"= 4))
```
...
```{r mapas-region, echo=FALSE, fig.topcaption = TRUE, fig.cap="Mapa de la distribución de los perfiles de cohesión social por región.", fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r tabla-empleo, echo=FALSE, fig.cap="Efecto del tipo de empleo sobre los perfiles de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
                            "Formal",
                            "Informal"
                            ),
             caption = "Efecto del tipo de empleo sobre los perfiles de cohesión social en porcentaje") %>%
...
Recuadro metodológico: _Clave para la lectura de las tablas_
...
```{r clases-edad, echo=FALSE, fig.cap="Efecto de la edad sobre los perfiles de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
                            "Entre 18 y 29",
                            "Entre 30 y 39",
             ...
             caption = "Efecto de la edad sobre los perfiles de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover"), latex_options = c("scale_down")) %>%
...
```{r clases-sexo, echo=FALSE, fig.cap="Efecto del sexo sobre los perfiles de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
                            "Hombre",
                            "Mujer"
                            ),
             caption = "Efecto del sexo sobre los perfiles de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
...
```{r clases-educacion, echo=FALSE, fig.cap="Efecto de la educación sobre los perfiles de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
             ...
             caption = "Efecto de la educación sobre los perfiles de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover"),latex_options = c("scale_down")) %>%
...
```{r clases-ingresos, echo=FALSE, fig.cap="Efecto de los quintiles de ingreso sobre los perfiles de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
                            "Quintil 1",
                            "Quintil 2",
             ...
             caption = "Efecto de los quintiles de ingreso sobre los perfiles de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover"),latex_options = c("scale_down")) %>%
...
```{r clases-etnia, echo=FALSE, fig.cap="Efecto de la pertenencia a una etnia sobre los perfiles de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
                            "Ninguna",
                            "Pertenece a una etnia"
                            ),
             caption = "Efecto de la pertenencia a una etnia sobre los perfiles de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
...
```{r clases-acced, echo=FALSE, fig.cap="Efecto de la proximidad a establecimientos educacionales sobre los perfiles de cohesion social", fig.align = 'center', out.width = '100%',out.height='100%'}
...
knitr::kable(collapse_rows_cohesion, table_format,
             ...
             caption = "Efecto de la proximidad a establecimientos educacionales sobre los perfiles de cohesion social") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
...
```{r clases-cesantes, echo=FALSE, fig.cap="Efecto de la proporción de trabajadores cesantes sobre los perfiles de cohesion social", fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
                            "Menor proporción de desempleados",
                            "Mayor proporción de desempleados"),
             caption = "Efecto de la proporción de trabajadores cesantes sobre los perfiles de cohesion social") %>%
  kable_styling(bootstrap_options = c("striped", "hover"),latex_options = c("scale_down")) %>%
...
```{r clases-accser, echo=FALSE, fig.cap="Efecto del acceso a servicios y equipamientos públicos sobre los perfiles de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Perfiles de cohesión social",
                            "Menor acceso a servicios",
                            "Alto acceso a servicios"
                            ),
             caption = "Efecto del acceso a servicios y equipamientos públicos sobre los perfiles de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
