...
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Clases de cohesión social",
                            ...
                            "Atomizados",
                            "N=100%"),
             caption = "Distribución de las clases latentes de cohesin social por región") %>%
...
```{r clases-escolaridad, echo=FALSE, fig.cap="Efecto del promedio de escolaridad del barrio sobre las clases de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Clases de cohesión social",
                            "Menor escolaridad",
                            "Alta escolaridad"
                            ),
             caption = "Efecto del promedio de escolaridad del barrio sobre las clases de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
...
```{r clases-ocupados, echo=FALSE, fig.cap="Efecto de la cantidad de trabajadores ocupados sobre las clases de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Clases de cohesión social",
                            "Menor cantidad de ocupados",
                            "Alta cantidad de ocupados"
                            ),
             caption = "Efecto de la cantidad de trabajadores ocupados sobre las clases de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
...
```{r clases-cesantes, echo=FALSE, fig.cap="Efecto de la cantidad de trabajadores cesantes sobre las clases de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Clases de cohesión social",
                            "Menor cantidad de cesantes",
                            "Alta cantidad de cesantes"
                            ),
             caption = "Efecto de la cantidad de trabajadores cesantes sobre las clases de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
...
```{r clases-acced, echo=FALSE, fig.cap="Efecto del acceso a colegios sobre las clases de cohesión social en porcentaje", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Clases de cohesión social",
                            "Menor acceso a colegios",
                            "Alto acceso a colegios"
                            ),
             caption = "Efecto del acceso a colegios sobre las clases de cohesión social en porcentaje") %>%
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
