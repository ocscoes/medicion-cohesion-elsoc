...
```{r esquema-cepal, echo=FALSE, fig.cap="Resumen de dimensiones de cohesión social de CEPAL.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
En este capítulo y los siguientes se  utilizaran los datos de la encuesta [**ELSOC** (Estudio Longitudinal Social de Chile)](https://coes.cl/encuesta-panel/) que se asocien al contenido de cada una de las dimensiones y subdimensiones del concepto de cohesión social. La selección de esta encuesta para este estudio se basa no solamente en la presencia de indicadores de cohesión social, sino también en que permitirá analizar cambios anuales de **trayectorias individuales** en dimensiones y subdimensiones de cohesión social entre 2016 y 2020. Dado que en esta encuesta panel se entrevista a las mismas personas año a año (N=3.000 app.), es posible analizar cambios en el tiempo de manera más precisa que mediante la comparación de distintas muestras en distintos momentos (donde no es posible precisar si los cambios en los indicadores se asocian a un momento distinto o a que las personas son distintas).
...
# condicional Table_format para que las tablas salgan en html y pdf
...
label(data$vol.red_w01) <- "Cantidad de personas que se conocen con diferentes ocupaciones."
label(data$c02_rec_w01) <- "Se puede confiar en la mayoria de las personas."
label(data$c03_rec_w01) <- "La mayoria de las personas tratan de ayudar a las demas."
label(data$c06_04_w01) <- "Grado de confianza con personas homosexuales."
label(data$c06_05_w01) <- "Grado de confianza con personas mapuche."
label(data$c06_06_w01) <- "Grado de confianza con personas inmigrantes."
label(data$c32_01_w01) <- "Me siento orgulloso de ser chileno."
label(data$c32_02_w01) <- "Me identifico con Chile."
label(data$c18_09_w01) <- "En Chile las personas son recompensadas por sus esfuerzos."
label(data$c18_10_w01) <- "En Chile las personas son recompensadas por su inteligencia."
label(data$c05_01_w01) <- "Confianza en el gobierno."
label(data$c05_02_w01) <- "Confianza en los partidos politicos."
label(data$c05_08_w01) <- "Confianza en el presidente/a de la republica."
label(data$c07_05_w01) <- "Ha donado dinero a una obra social o de caridad."
label(data$c07_06_w01) <- "Ha prestado una suma de dinero de $10.000.- o mas."
label(data$c07_07_w01) <- "Ha conversado con una persona en problemas o deprimida."
label(data$c07_08_w01) <- "Ha ayudado a alguien a conseguir trabajo."
label(data$c08_01_w01) <- "Firmado una carta o peticion apoyando una causa."
label(data$c08_02_w01) <- "Asistido a una marcha o manifestacion pacifica."
label(data$c08_03_w01) <- "Participado en una huelga."
label(data$c08_04_w01) <- "Usado las redes sociales para expresar su opinion en temas publicos."
label(data$t02_01_w01) <- "Este barrio es ideal para mi."
label(data$t02_02_w01) <- "Me siento integrado/a en este barrio."
label(data$t02_03_w01) <- "Me identifico con la gente de este barrio."
label(data$t02_04_w01) <- "Este barrio es parte de mi."
...
collapse_rows_cohesion <-
    data.frame(vars = c(rep("Lazos", 1),
           ...
           rep("Vínculos territoriales", 4)),
           cohesion.item,cohesion.min,cohesion.mean)
```

```{r descriptivos-cohesion, echo=FALSE, fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(collapse_rows_cohesion, table_format,
             col.names =  c("Subdimensión",
                            "Indicadores",
                            "Min - max",
                            "Mean (sd)"),
             caption = "Descriptivos de medición de cohesión social.") %>%
...
```{r confianza-interpersonal, echo=FALSE, fig.cap="Confianza interpersonal.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r confianza-interpersonal-cor, echo=FALSE, fig.cap="Asociación de indicadores de Confianza interpersonal.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r prejuicios, echo=FALSE, fig.cap="Prejuicios hacia inmigrantes y adopción homoparental.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/prejuicios.png")
```

```{r diversidad, echo=FALSE, fig.cap="Grado de confianza hacia distintos grupos sociales.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/diversidad.png")
```

```{r diversidad-cor, echo=FALSE, fig.cap="Asociación de indicadores de la subdimensión Reconocimiento y respeto de la diversidad.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r div-fa, echo=FALSE, fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(data.frame(image='![](output/tables/div_fa.png){width="650"}'),    # generar tabla
...
```{r lazos, echo=FALSE, fig.topcaption = TRUE, fig.cap="Item subdimension Lazos.", fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/lazos.png")
```

```{r lazos-cor, echo=FALSE, fig.cap="Asociación de indicadores de subdimensión lazos.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r identificacion, echo=FALSE, fig.cap="Identificación y orgullo con Chile.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r justicia, echo=FALSE, fig.cap="Percepción de recompensa por esfuerzo e inteligencia.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r confianza-institucional, echo=FALSE, fig.cap="Confianza en instituciones.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/confianza-institucional.png")
```

```{r confianza-institucional-cor, echo=FALSE, fig.cap="Asociación de indicadores de confianza institucional.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r inst-fa, echo=FALSE, fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(data.frame(image='![](output/tables/inst_fa.png){width="650"}'),    # generar tabla
...
```{r solidaridad, echo=FALSE, fig.cap="Acciones de solidaridad.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/solidaridad.png")
```

```{r solidaridad-cor, echo=FALSE, fig.cap="Asociación de indicadores de solidaridad.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r solidaridad-fa, echo=FALSE, fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(data.frame(image='![](output/tables/solidaridad_fa.png){width="650"}'),    # generar tabla
...
```{r participacion-civica, echo=FALSE, fig.cap="Participación en actividades cívicas.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/participacion-civica.png")
```

```{r participacion-civica-cor, echo=FALSE, fig.cap="Asociación de indicadores de participación cívica.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/participacion-civica_cor.png")
```

**Participación en organizaciones**

```{r participacion-organizaciones, echo=FALSE, fig.cap="Participación en organizaciones sociales.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/participacion-organizaciones.png")
```

```{r participacion-organizaciones-cor, echo=FALSE, fig.cap="Asociación de indicadores participación en organizaciones sociales.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/participacion-organizaciones_cor.png")
```

**Participación electoral**

```{r participacion-electoral, echo=FALSE, fig.cap="Participación en elecciones 2013.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r participacion-fa, echo=FALSE, fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(data.frame(image='![](output/tables/participacion_fa.png){width="650"}'),    # generar tabla
...
```{r confianza-vecinos, echo=FALSE, fig.cap="Confianza en vecinos.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r cohesion-barrial, echo=FALSE, fig.cap="Cohesión en el barrio.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/cohesion-barrial.png")
```

```{r cohesion-barrial-cor, echo=FALSE, fig.cap="Asociación de indicadores de cohesión barrial.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r sociabilidad-barrial, echo=FALSE, fig.cap="Sociabilidad barrial.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/sociabilidad-barrial.png")
```

```{r sociabilidad-barrial-cor, echo=FALSE, fig.cap="Asociación de indicadores de sociabilidad barrial.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r satisfaccion-residencial, echo=FALSE, fig.cap="Satisfacción con el barrio.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::include_graphics(path = "output/graphs/satisfaccion-residencial.png")
```

```{r satisfaccion-residencial-cor, echo=FALSE, fig.cap="Asociación de indicadores de satisfacción residencial.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
...
```{r cohesion-territorial-fa, echo=FALSE, fig.topcaption = TRUE, fig.align = 'center', out.width = '100%',out.height='100%'}
knitr::kable(data.frame(image='![](output/tables/cohesion_territorial_fa.png){width="650"}'),    # generar tabla
             caption = "Dimensiones de vínculos territoriales.",
             col.names = "",
             row.names = F,
             format = "pipe") %>%  kable_styling(latex_options = c("HOLD_position"),full_width = T)
```

## Relación entre las subdimensiones de cohesión social
...
```{r cohesion-social-cor, echo=FALSE, fig.cap="Asociación de las subdimensiones de cohesión social.", fig.topcaption = TRUE, fig.align = 'center', out.width = '100%', out.height='100%'}
